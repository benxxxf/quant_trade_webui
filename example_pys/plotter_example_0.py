...
class DataframePlotterExample0(DataFramePlotter):
    ...
    def __init__(self):
        ...
        merged_df, df_list = csmar_parser.create_df_from_database(
            ...
            file_sql_appendcmd={
                "E:/BenQTrade/ben-qtrade/database/国内指数日行情文件_19901219_20260729.parquet": "WHERE 交易所指数代码='1'",
                "E:/BenQTrade/ben-qtrade/database/国内股票指数日市值文件_19910715_20260729.parquet": "WHERE 交易所指数代码='1'",
            },
        )
